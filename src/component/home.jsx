...
return <div>
  ...
  <div class="container-fluid">
    ...
    <form class="d-flex">
        <Link to="/cart" class="btn success" style={{background:'black',color:'white'}} type="submit">cart items ({savedProductData.length})</Link>
      </form>
...
<div class="card" style={{width: "260px",margin:"5px"}}>
  ...
  <div class="card-body">
    ...
    <button onClick={()=>{dispatchProductData({type:"add",payload:{id:pro.id,name:pro.name,img:pro.pic}})}} class="btn btn-primary">add to cart</button>
  </div>
</div>
  ))
}
